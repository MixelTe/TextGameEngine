...
function createInfDiv(ru = false) {
    ...
    if (ru)
        div1.innerText = "Информационное окно, сюда можно добавить любой html";
    else
        div1.innerText = "Info div, you can add any html here";
    const div2 = document.createElement("div");
    infDiv.appendChild(div2);
    if (ru)
        div2.innerText = "Заголовок всплывающего окна - Titles.title\nВторая текстовая строка - Titles.version.";
    else
        div2.innerText = "The popup title is Titles.title\nThe second text line is Titles.version.";
...
infDiv.appendChild(div);\n`;
    if (ru)
        preInnerText += 'div.innerText = "Здесь вы можете разместить, например, описание игры";';
    else
        preInnerText += 'div.innerText = "Here you can place, for example, a description of the game";';
    pre.innerText = preInnerText;
    pre.style.whiteSpace = "break-spaces";
    const div3 = document.createElement("div");
    infDiv.appendChild(div3);
    if (ru)
        div3.innerText = "Здесь вы можете разместить, например, описание игры";
    else
        div3.innerText = "Here you can place, for example, a description of the game";
}
async function main() {
    tge.clear();
